...
import gestionPersonneStructure.PersonneStructureAjouter;
import gestionPersonneStructure.PersonneStructureLister;
import gestionPersonneStructure.PersonneStructureModifier;
import gestionStructure.StructureAjouter;
import gestionStructure.StructureLister;
import gestionStructure.StructureModifier;
...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        JMenuLMS = new javax.swing.JMenuItem();
        ...
        jMenuAjout.setText("Ajout Structure");
        jMenuAjout.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuAjoutActionPerformed(evt);
            }
        });
        jMenu1.add(jMenuAjout);

        JMenuLMS.setText("Lister/Modifier/Supprimer");
        JMenuLMS.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JMenuLMSActionPerformed(evt);
            }
        });
        jMenu1.add(JMenuLMS);
        ...
        jMenu2.setText("Personne");

        jMenuItem2.setText("Ajout Personne");
        ...
        jMenuItem4.setText("Lister/Modifier/Supprimer");
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
       // this.dispose();
        ...
        try {
            ...
            ObjectOutputStream fluxStructure = new ObjectOutputStream(fichierStructure);
            fluxStructure.writeObject(NezDamesSerialisation.lesStructures);

            //sérialisation des personne structure
            FileOutputStream fichierPersonneStructure = new FileOutputStream("lesPersonnes.txt");
            ObjectOutputStream fluxPersonneStructure = new ObjectOutputStream(fichierPersonneStructure);
            fluxStructure.writeObject(NezDamesSerialisation.lesPersonnesStructures);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try {
            ...
            FileInputStream fichierPersonneStructure = new FileInputStream("lesPersonnes.txt");
            ObjectInputStream fluxPersonneStructure = new ObjectInputStream(fichierPersonneStructure);
            NezDamesSerialisation.lesPersonnesStructures = (ArrayList<PersonneStructure>) fluxPersonneStructure.readObject();
        } catch (IOException e) {
    ...
    private void JMenuLMSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JMenuLMSActionPerformed
        new StructureLister().setVisible(true);
    }//GEN-LAST:event_JMenuLMSActionPerformed
    ...
    private javax.swing.JMenuItem JMenuLMS;
