...
public class GenererPdfContratCession {
  ...
  private static void ajoutContenu(Document document) throws DocumentException, BadElementException, IOException {
    ...
    subCatPart.add(new Paragraph("       Raison sociale : "+leContrat.getLaStructure().getRaisonSociale()));
    subCatPart.add(new Paragraph("       S.I.R.E.T. N° : "+leContrat.getLaStructure().getNumeroSiret()+"     NAF : "+leContrat.getLaStructure().getCodeNafOuApe()));
