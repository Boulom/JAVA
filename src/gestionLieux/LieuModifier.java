...
public class LieuModifier extends javax.swing.JFrame {
    ...
    private int lIndexDuLieu;

    public LieuModifier(int laLigneSelectionnee) {
        initComponents();
        ...
        lIndexDuLieu = laLigneSelectionnee;
    }
    ...
    private void initComponents() {
        ...
        lblTitre1.setText("MODIFICATION D'UN LIEU ");
            ...
            if (txtRue.getText().compareTo("") == 0) {
                ...
                if (txtCodePostal.getText().compareTo("") == 0) {
                    ...
                    if (txtVille.getText().compareTo("") == 0) {
                        ...
                        NezDamesSerialisation.lesLieux.get(lIndexDuLieu).modifier(txtNom.getText(), txtRue.getText(), txtVille.getText(), Integer.parseInt(txtCodePostal.getText()));
